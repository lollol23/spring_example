...
<body>
	...
	<h2>문자열 쪼개기</h2>
	<h4>${fn:split(str2, " ")[0] }</h4>
	<h4>${fn:split(str2, " ")[1] }</h4>
	...
	<h2>문자열 대소문자 변경</h2>
	<h4>모두대소문자변경 ${fn:toLowerCase(str2) }</h4>
	<h4>모두대소문자변경 ${fn:toUpperCase(str2) }</h4>
	
	<h2>앞뒤 공백제거</h2>
	<c:set var="str3" value= "         hello      " />
	<pre>str: ${str3 }</pre>
	<pre>trim적용: ${fn:trim(str3) }</pre>
</body>
</html>